    ...
    <div class="max-w-lg mx-auto bg-white rounded-2xl shadow-lg p-8 py-10 mt-10 mb-10">
        ...
        <form @submit.prevent="handleSubmit" class="mt-6 space-y-5">
            ...
            <button type="submit" :disabled="loading"
                class="w-full py-3 bg-primary text-black font-bold rounded-lg shadow-md hover:bg-gray-400 transition duration-300 flex justify-center items-center disabled:opacity-50 disabled:cursor-not-allowed">
