    ...
    <footer class="bg-gray-900 text-gray-300 py-8">
        <div
            ...
            <div class="flex space-x-4 mt-4 md:mt-0 lg:ml-40">
                <a :href="userInfo.Github" target="_blank" class="hover:text-gray-400 transition">
                    <i class="fab fa-github text-xl"></i>
                </a>
                <a :href="userInfo.LinkedIn" target="_blank" class="hover:text-gray-400 transition">
                    <i class="fab fa-linkedin text-xl"></i>
                </a>
                <a :href="'mailto:' + userInfo.Email" class="hover:text-gray-400 transition">
