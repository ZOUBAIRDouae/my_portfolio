    ...
    <div class="max-w-screen-xl mx-auto px-4">
      ...
      <div v-if="skills.length"
        ...
        <div v-for="skill in skills" :key="skill.id"
          class="text-center bg-white p-6 shadow-lg rounded-lg hover:shadow-2xl hover:scale-105 transition-transform">
          <!-- Skill Icon -->
            ...
            <template v-if="skill.icon === 'tailwind-logo-svg'">
              <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="#000000"
                ...
                <path
                  ...
                  style="fill: black !important"></path>
              </svg>
            </template>
            <template v-else>
              <span v-html="skill.icon" class="w-16 h-16 sm:w-20 sm:h-20 text-black"></span>
            </template>
          </div>
          ...
          <div class="mt-3">
            ...
            <p class="text-sm sm:text-base font-medium text-black">
              {{ skill.level }}
            </p>
          </div>
        </div>
